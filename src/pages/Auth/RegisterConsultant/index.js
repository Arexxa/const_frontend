...
import { useRegisterConsultant } from './contexts/RegisterConsultantContext'
...
function RegisterConsultant() {
    ...
    const [saveCompanyDetails, setsaveCompanyDetails] = useState([])
    const [step, setStep] = useState(1)
    const navigate = useNavigate()
    const userId = localStorage.getItem('userid')

    useEffect(() => {
        console.log('Saved company details:', saveCompanyDetails)
    }, [saveCompanyDetails])
        ...
        switch (step) {
            ...
            case 2:
                try {
                    ...
                    console.log('Company details registered successfully.')
